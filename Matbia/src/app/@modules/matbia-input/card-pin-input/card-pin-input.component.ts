...
const CREDIT_PIN_CONTROL_VALUE_ACCESSOR: Provider = {
  provide: NG_VALUE_ACCESSOR,
  // tslint:disable-next-line: no-use-before-declare
  useExisting: forwardRef(() => CardPinInputComponent),
  multi: true,
};
...
@Component({
  ...
  `,
  providers: [CREDIT_PIN_CONTROL_VALUE_ACCESSOR],
  imports: [SharedModule, InputErrorComponent],
})
export class CardPinInputComponent implements ControlValueAccessor, AfterContentInit {
  // tslint:disable-next-line: no-input-rename
  @Input('cardMask') cardMask = '0000';
