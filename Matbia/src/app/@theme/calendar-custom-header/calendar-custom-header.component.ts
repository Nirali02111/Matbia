...
@Component({
  selector: 'app-calendar-custom-header',
  templateUrl: './calendar-custom-header.component.html',
  styleUrl: './calendar-custom-header.component.css',
...
export class CalendarCustomHeaderComponent<D> implements OnDestroy {
  ...
  get periodLabel(): string {
    ...
    return this.dateAdapter.format(this.calendar.activeDate, { month: 'long', year: 'numeric' }).toLocaleUpperCase();
  }
