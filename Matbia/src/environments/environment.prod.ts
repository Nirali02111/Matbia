export const environment = {
  ...
  GOOGLE_ANALYTIC_API_KEY: 'G-JTFJ45NLSW',
  GOOGLE_ANALYTIC_KEEP_UTM_PARAMETER: false,
  production: true,
  PLAID_ENV: 'production',

  DONATE_API_TOKEN: 'D86D0404-BFA7-46C6-A0A5-71C4A2B9F633',
  MATBIA_API_TOKEN: 'D86D0404-BFA7-46C6-A0A5-71C4A2B9F633',
};
